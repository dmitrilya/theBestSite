  ...
  render() {
    return (<div className="window">
      <table className="table3">
        ...
        <tr>
          <td><Input className="cell" onClick={this.game} type="button" name="1,0" inputRef={input => this.btn3 = input}/></td>
          <td><Input className="cell" onClick={this.game} type="button" name="1,1" inputRef={input => this.btn4 = input}/></td>
          <td><Input className="cell" onClick={this.game} type="button" name="1,2" inputRef={input => this.btn5 = input}/></td>
        </tr>
        <tr>
          <td><Input className="cell" onClick={this.game} type="button" name="2,0" inputRef={input => this.btn6 = input}/></td>
          <td><Input className="cell" onClick={this.game} type="button" name="2,1" inputRef={input => this.btn7 = input}/></td>
          <td><Input className="cell" onClick={this.game} type="button" name="2,2" inputRef={input => this.btn8 = input}/></td>
        </tr>
      </table>
